...
const commands: Record<string, () => string[]> = {
  ...
  about: () => [
    "Hi, I'm Hieu!",
    'A fullstack web developer and a member of Little Boy\'s.',
    'Software Engineering student at FPT University,',
    'passionate about system design and distributed architecture.',
  ],
  skills: () => [
    'Technical Skills:',
    '  Frontend:   React, TypeScript, TailwindCSS, Ant Design, Vite',
    '  Backend:    Spring Boot 3, FastAPI, Spring Security, JWT',
    '  Database:   MySQL, PostgreSQL, MongoDB, Firebase',
    '  DevOps:     Docker, GitHub Actions, Vercel, NginX',
    '  AI/ML:      FAISS, NLU, Vietnamese SBERT, Semantic Search',
    '  Security:   Burp Suite, Nmap, Ghidra',
    '  Testing:    Playwright, Vitest, JUnit, pytest',
  ],
  projects: () => [
    'Featured Projects:',
    '  1. Data Labeling Support System - Frontend Lead (4 members)',
    '  2. HistoryMind AI - Fullstack & AI Engineer (Solo)',
    '  3. EduFlow Platform - Fullstack Developer (Team of 6)',
    '',
  ...
  whoami: () => ['hieu@portfolio ~ fullstack web developer'],
